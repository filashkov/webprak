...
import com.filashkov.webprak.DAO.GenericDAO;
...
@Repository
public abstract class GenericDAOImplementation<T extends GenericEntity<ID>, ID extends Serializable> implements GenericDAO<T, ID> {
