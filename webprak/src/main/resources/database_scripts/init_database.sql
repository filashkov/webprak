...
('Цифровое право', 'Защита в области информационных технологий', 200);
...
VALUES
('Николаев Пётр Никифорович', 'Москва', 89150879678, 'niks@gmail.com', 'niks', 'dsfhgjhkjl', 'Администратор', 1),
('Юрьев Евгений Максимович', 'Подольск', 89163572938, 'uru@yandex.ru', 'uru', 'dfbhbdkfk', 'Юрист', 0),
('Алексеев Максим Петрович', 'Москва', 89268579709, 'aleks@mail.ru', 'aleks', 'lnddskbjn', 'Юрист', 0);
